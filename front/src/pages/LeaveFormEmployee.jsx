          ...
          <div>
            ...
            >
              <div className="mt-10 flex flex-col gap-4 ml-14">
                ...
                <label className="mr-0 text-lg font-medium text-blue-950">
                  InchargeName <span className="text-red-500">*</span>
                  <input
                    type="text"
                    value={inchargename}
                ...
                <label className="mr-1 mt-1 text-lg font-medium text-blue-950">
                  Leave Reason
                </label>
                ...
                <textarea
                  ...
                  className="ml-16 mt-1 border-2 px-4 py-2 w-50 rounded-md focus:outline-none focus:ring"
                  rows="3" 
                />
